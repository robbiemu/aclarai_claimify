...
class SearchResultsValidator:
    ...
    def _filter_blocked_domains(
        self, results: List[Dict[str, Any]], blocklist: Optional[List[Tuple[str, str]]]
    ...
    def _validate_url_batch(
        self, results_batch: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
                ...
                async def do_request():
                    async with RATE_MANAGER.acquire(
                        ...
                        return await HTTP_CLIENT.head(
                            ...
                            headers={"User-Agent": "DataScout/1.0"},
                        )
    ...
    def _filter_fresh_results(
        self, results: List[Dict[str, Any]], bad_urls: Set[str]
    ) -> List[Dict[str, Any]]:
