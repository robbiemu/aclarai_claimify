...
def run(
    ...
    mission_runner = MissionRunner("settings/scout_mission.yaml")
    ...
    total_samples_target = mission_runner.calculate_total_samples(mission_name)
    print(
    ...
    if resume_from:
        ...
        thread_id = mission_runner.start_new_mission(mission_name, recursion_limit)
    ...
    while max_iterations is None or iteration_count < max_iterations:
        try:
            ...
            # Run mission step
            step_result = mission_runner.run_mission_step(thread_id, user_input, recursion_limit)
