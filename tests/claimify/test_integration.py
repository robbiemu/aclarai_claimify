...
# NOTE: Integration tests that depend on external modules have been removed
# These tests required aclarai_shared package and Neo4j database connections
# which are not part of this decoupled claimify package.
# Core functionality is fully tested by the unit tests that do not require external dependencies.
# 
