...
def test_arxiv_search_vs_content():
    ...
    try:
        from aclarai_claimify.scout.tools import arxiv_search, arxiv_get_content
        ...
        if content_result.get("status") == "ok":
            ...
            if results:
                ...
                print(f"First document content length: {len(first_doc.get('content', ''))} characters")
                # Show first 500 characters of content
                print(f"First document content preview: {str(first_doc.get('content', ''))[:500]}...")
...
def test_wikipedia_search_vs_content():
    ...
    try:
        from aclarai_claimify.scout.tools import wikipedia_search, wikipedia_get_content
