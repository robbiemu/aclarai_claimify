...
# Add the project root to the path so we can import the scout module
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

from aclarai_claimify.scout.tools import get_tools_for_role, _truncate_response_for_role
...
class TestToolTruncation(unittest.TestCase):
    ...
    def test_truncate_response_for_role_no_truncation(self):
        ...
        with patch('aclarai_claimify.scout.tools.load_claimify_config') as mock_config:
            # Mock config to return a large max_tokens
            mock_config.return_value.scout_agent.mission_plan.get_node_config.return_value.max_tokens = 1000
    ...
    def test_truncate_response_for_role_with_truncation(self):
        ...
        with patch('aclarai_claimify.scout.tools.load_claimify_config') as mock_config:
            ...
            mock_config.return_value.scout_agent.mission_plan.get_node_config.return_value.max_tokens = 10  # 40 characters
