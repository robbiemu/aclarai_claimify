...
from aclarai_claimify.scout.nodes import supervisor_node
...
def test_supervisor_prevents_duplicate_consecutive_agent_calls():
    ...
    with unittest.mock.patch("aclarai_claimify.scout.nodes.create_llm") as mock_create_llm_func, \
         unittest.mock.patch("aclarai_claimify.scout.nodes.load_claimify_config") as mock_config_func:
