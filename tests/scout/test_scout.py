...
from aclarai_claimify.scout.models import (
    ScoutAgentConfig,
...
def test_scout_agent_runnable_new_mission(
    ...
    mock_mission_runner.assert_called_once_with("settings/mission_config.yaml")
...
@patch("aclarai_claimify.scout.main.MissionRunner")
@patch("aclarai_claimify.scout.main.load_claimify_config")
def test_scout_agent_runnable_resume_mission(
    mock_load_config, mock_mission_runner, mock_input
):
    """
